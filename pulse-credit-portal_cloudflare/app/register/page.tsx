...
function RegisterForm() {
    ...
    return (
        <div className="container mx-auto py-12 px-4 min-h-screen flex flex-col items-center justify-center">
            {score && (
                <div className="mb-8 p-6 bg-violet-600 rounded-3xl text-white shadow-2xl shadow-violet-200 flex items-center gap-6 animate-in fade-in zoom-in duration-500 max-w-2xl w-full">
                    <div className="bg-white/20 p-4 rounded-2xl">
                        <Trophy className="w-8 h-8 text-white fill-current" />
                    </div>
                    <div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <h3 className="text-sm font-bold text-zinc-400 uppercase tracking-widest ml-1">Credentials</h3>
                                <div className="space-y-3">
                                    <Label htmlFor="email" className="text-sm font-semibold text-zinc-700 ml-1">Login Email</Label>
                            ...
                            <div className="space-y-4">
                                <h3 className="text-sm font-bold text-zinc-400 uppercase tracking-widest ml-1">Company</h3>
                                <div className="space-y-3">
                                    <Label htmlFor="companyName" className="text-sm font-semibold text-zinc-700 ml-1">Business Name</Label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="space-y-3">
                                <Label htmlFor="corporateEmail" className="text-sm font-semibold text-zinc-700 ml-1">Corp Email</Label>
                            ...
                            <div className="space-y-3">
                                <Label htmlFor="phone" className="text-sm font-semibold text-zinc-700 ml-1">Phone</Label>
